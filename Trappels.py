                                        ...
                                        while block<long:
                                            ...
                                            if file==0:
                                                ...
                                                while Combination5!=1:
                                                    ...
                                                    if Combination==(2**24)-1:
                                                        Combination5=1
                                                    if Combination1==(2**22)-1:
                                                        Combination5=1
                                                    ...
                                                    Combination+=1
                                                    Combination2=format(Combination,'024b')
                                        ...
                                        while block<long:
                                            ...
                                            if file==0:
                                                ...
                                                if Calculus[0:1]=="0":
                                                    ...
                                                    Calculus=size_data3[block:block+23]
                                                    long2=len(Calculus)
                                                    block+=23
                                                    blocks=23
                                                    ...
                                                    #print(Times2)
                                                                    ...
                                                                    if Combination2[Times:Times+3]==Combination2[Times2:Times2+3] and Calculus[Times:Times+3]==Calculus[Times3:Times3+3]  and Times!=Times3 and Times2!=Times and Times2!=Times3 and res3==0 and long2==blocks:
                                                                        res3=1
